        ...
        <div class="grid">
            ...
            <div>
                <ul>
                    ...
                    <li v-if="profileData.segments[0].stats.season4Wins">
                        <h4>Season 4 Wins</h4>
                        <p>
                            {{profileData.segments[0].stats.season4Wins.displayValue}}
                            <span>({{profileData.segments[0].stats.season4Wins.percentile}}%)</span>
                        </p>
                    </li>
